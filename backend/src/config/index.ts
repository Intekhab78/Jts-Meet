...
export const BACKEND_API_URL = process.env.BACKEND_API_URL || (isProductionPlatform ? 'https://meet.jtsmiddleeast.com' : 'http://localhost:4000')
export const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'admin@jtsmeet.com'
