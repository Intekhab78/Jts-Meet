        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
            <div className="w-full max-w-md glass-card p-6 shadow-xl text-white anim-scale-in">
                <div className="flex items-center justify-between mb-5 border-b border-white/5 pb-3">
                    <h2 className="text-lg font-bold">Invite Channel Member</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <select value={role} onChange={(e) => setRole(e.target.value as Exclude<ChannelRole, 'owner'>)} className="input py-2">
